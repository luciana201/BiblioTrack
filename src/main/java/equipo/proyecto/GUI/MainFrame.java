...
public class MainFrame extends JFrame {
    ...
    private void initUI() {
        ...
        // Por ahora paneles vacíos — los rellenaremos en los pasos 2 y 3
        panelContenido.add(new JLabel(
            "  Bienvenido, " + usuarioActual.getNombre(),
            SwingConstants.CENTER), "INICIO");
        panelContenido.add(new JLabel(
            "  Búsqueda próximamente",
            SwingConstants.CENTER), "BUSCAR");
    ...
    private JPanel crearTopBar() {
        ...
        JMenuItem itemVerCuenta =
            new JMenuItem("Ver cuenta");
        JMenuItem itemCerrarSesion =
            new JMenuItem("Cerrar sesión");
    ...
    public void abrirDetalle(Publicacion pub) {
        PanelDetalleLibro detalle =
            new PanelDetalleLibro(
                pub, usuarioActual,
                biblioteca, labelEstado);
